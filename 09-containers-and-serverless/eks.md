...
![Kubernetes 101](images/Kubernetes101.png)
...
- EKS can be run in different ways:
  ...
  - EKS Anywhere: based on EKS Distro (open source Kubernetes distribution used by AWS) to deploy EKS clusters running on on-premises or anywhere else. Possible to pay for Enterprise Subscription and have 24/7 support.
